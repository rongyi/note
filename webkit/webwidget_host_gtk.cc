...
void WebWidgetHost::Paint() {
  ...
  if (rgba) {
    ...
    cairo_set_source_rgba (cairo_drawable_transparent, 1.0, 1.0, 1.0, 0.0);
    cairo_set_operator (cairo_drawable_transparent, CAIRO_OPERATOR_SOURCE);
    cairo_paint(cairo_drawable_transparent);
    cairo_destroy(cairo_drawable_transparent);
    cairo_set_source_surface(cairo_drawable, cairo_get_target(cairo_drawable_transparent),
                           0, 0);
	cairo_paint(cairo_drawable);
  }
 */ 
